...
router.post("/", uploads_middleware_1.uploadFotoMahasiswa.single("foto"), mahasiswa_controller_1.createMahasiswa);
router.put("/:id", uploads_middleware_1.uploadFotoMahasiswa.single("foto"), mahasiswa_controller_1.updateMahasiswa);
